...
# run test
NDS_DATA=${NDSDATADIR} ./bench_queries -i ./logs/gaussian.log -x ../xml/gaussian_1M.xml -d 10 > ${TMPDIR}/pdigest_${EXECID}_gaussian_1M.csv
...
# run test
NDS_DATA=${NDSDATADIR} ./bench_queries -i ./logs/gaussian.log -x ../xml/gaussian_1M.xml -d 10 > ${TMPDIR}/raw_${EXECID}_gaussian_1M.csv
