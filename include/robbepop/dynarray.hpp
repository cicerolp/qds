// from: https://github.com/Robbepop/dynarray
//===---------------------------------------------------------
//                       DYNARRAY
//===---------------------------------------------------------
//
...
#ifndef STDE_DYNARRAY_HPP
#define STDE_DYNARRAY_HPP
...
namespace stde {
	...
	//============================================================
		explicit dynarray(size_type count = 0);
...
//============================================================
template<typename T>
stde::dynarray<T>::dynarray(size_type count):
	m_data{new T[count]},
	m_size{count}
{}
...
template<typename T>
template<class Alloc>
stde::dynarray<T>::dynarray(size_type count, Alloc const& alloc):
...
//============================================================
template<typename T>
stde::dynarray<T>::dynarray(size_type count, T const& value):
	m_data{new T[count]},
	m_size{count}
{
...
template<typename T>
template<class Alloc>
stde::dynarray<T>::dynarray(size_type count, T const& value, Alloc const& alloc):
	m_data{alloc.allocate(count)},
	m_size{count}
{
	std::fill(begin(), end(), value);
...
//============================================================
template<typename T>
stde::dynarray<T>::dynarray(dynarray const& other):
...
template<typename T>
template<class Alloc>
stde::dynarray<T>::dynarray(dynarray const& other, Alloc const& alloc):
...
//============================================================
template<typename T>
stde::dynarray<T>::dynarray(dynarray && other):
...
//============================================================
template<typename T>
stde::dynarray<T>::dynarray(std::initializer_list<T> list):
...
template<typename T>
template<class Alloc>
stde::dynarray<T>::dynarray(std::initializer_list<T> list, Alloc const& alloc):
...
template<typename T>
auto stde::dynarray<T>::operator=(dynarray const& other) -> dynarray & {
	if (size() != other.size()) {
...
template<typename T>
auto stde::dynarray<T>::operator=(dynarray && other) -> dynarray & {
...
template<typename T>
auto stde::dynarray<T>::operator=(std::initializer_list<T> list) -> dynarray & {
	if (size() != list.size()) {
		using namespace std::string_literals;
		throw std::invalid_argument{
...
template<typename T>
auto stde::dynarray<T>::at(size_type pos) -> reference {
	if (pos >= size()) {
		using namespace std::string_literals;
...
template<typename T>
auto stde::dynarray<T>::at(size_type pos) const -> const_reference {
	if (pos >= size()) {
		using namespace std::string_literals;
		throw std::out_of_range{
			"cannot access element at position "s + 
...
template<typename T>
auto stde::dynarray<T>::operator[](size_type pos) -> reference {
	return m_data[pos];
}

template<typename T>
auto stde::dynarray<T>::operator[](size_type pos) const -> const_reference {
	return m_data[pos];
}

template<typename T>
auto stde::dynarray<T>::front() -> reference {
	return m_data[0];
}

template<typename T>
auto stde::dynarray<T>::front() const -> const_reference {
	return m_data[0];
}

template<typename T>
auto stde::dynarray<T>::back() -> reference {
	return m_data[size() - 1];
}

template<typename T>
auto stde::dynarray<T>::back() const -> const_reference {
	return m_data[size() - 1];
}

template<typename T>
auto stde::dynarray<T>::data() -> pointer {
	return m_data.get();
}

template<typename T>
auto stde::dynarray<T>::data() const -> const_pointer {
	return m_data.get();
}
...
template<typename T>
auto stde::dynarray<T>::empty() const -> bool {
	return m_size == 0;
}

template<typename T>
auto stde::dynarray<T>::size() const -> size_type {
	return m_size;
}
...
template<typename T>
void stde::dynarray<T>::fill(T const& value) {
	std::fill(begin(), end(), value);
}
...
template<typename T>
auto stde::dynarray<T>::begin() -> iterator {
	return m_data.get();
}

template<typename T>
auto stde::dynarray<T>::begin() const -> const_iterator {
	return m_data.get();
}

template<typename T>
auto stde::dynarray<T>::cbegin() const -> const_iterator {
	return m_data.get();
}


template<typename T>
auto stde::dynarray<T>::end() -> iterator {
	return m_data.get() + size();
}

template<typename T>
auto stde::dynarray<T>::end() const -> const_iterator {
	return m_data.get() + size();
}

template<typename T>
auto stde::dynarray<T>::cend() const -> const_iterator {
	return m_data.get() + size();
}


template<typename T>
auto stde::dynarray<T>::rbegin() -> reverse_iterator {
	return reverse_iterator{end()};
}

template<typename T>
auto stde::dynarray<T>::rbegin() const -> const_reverse_iterator {
	return reverse_iterator{end()};
}

template<typename T>
auto stde::dynarray<T>::crbegin() const -> const_reverse_iterator {
	return reverse_iterator{cend()};
}


template<typename T>
auto stde::dynarray<T>::rend() -> reverse_iterator {
	return reverse_iterator{begin()};
}

template<typename T>
auto stde::dynarray<T>::rend() const -> const_reverse_iterator {
	return reverse_iterator{begin()};
}

template<typename T>
auto stde::dynarray<T>::crend() const -> const_reverse_iterator {
	return reverse_iterator{cbegin()};
}

#endif // STDE_DYNARRAY_HPP